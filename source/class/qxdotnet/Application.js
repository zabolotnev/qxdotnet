    ...
    members:
    {
        ...
        */
        ...
        prepareReferences: function() {
            ...
            a = new qx.ui.command.Command();
            a = new qx.ui.command.Group();
            a = new qx.ui.command.GroupManager();
            ...
            a = new qx.ui.core.DragDropScrolling();
            ...
            a = new qx.ui.progressive.renderer.Abstract();
            a = new qx.ui.progressive.renderer.FunctionCaller();
            a = new qx.ui.progressive.renderer.table.cell.Abstract();
            a = new qx.ui.progressive.renderer.table.cell.Boolean();
            a = new qx.ui.progressive.renderer.table.cell.Conditional();
            a = new qx.ui.progressive.renderer.table.cell.Default();
            a = new qx.ui.progressive.renderer.table.cell.Html();
            a = new qx.ui.progressive.renderer.table.cell.Icon();
            a = new qx.ui.progressive.renderer.table.cell.Image();
            a = new qx.ui.progressive.renderer.table.cell.String();
            a = new qx.ui.progressive.renderer.table.Row();
            a = new qx.ui.progressive.renderer.table.Widths();
            a = new qx.ui.progressive.State();
            a = new qx.ui.progressive.structure.Abstract();
            a = new qx.ui.progressive.structure.Default();
