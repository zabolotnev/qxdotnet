...
namespace qxDotNet.UI.Core
{
    ...
    public partial class Widget : qxDotNet.UI.Core.LayoutItem
    {
        ...
        /// <summary>
        /// Whether the widget is enabled. Disabled widgets are usually grayed out and do not process user created events. While in the disabled state most user input events are blocked. Only the {@link #mouseover} and {@link #mouseout} events will be dispatched.
        /// </summary>
        public bool? Enabled
        {
            get
        ...
        /// <summary>
        /// Whether the widget is focusable e.g. rendering a focus border and visualize as active element.  See also {@link #isTabable} which allows runtime checks for isChecked or other stuff to test whether the widget is reachable via the TAB key.
        /// </summary>
        ...
        /// <summary>
        /// If this property if enabled, the widget and all of its child widgets will never get activated. The activation keeps at the currently activated widget.  This is mainly useful for widget authors. Please use with caution!
        /// </summary>
        ...
        /// <summary>
        /// If this property is enabled, the widget and all of its child widgets will never get focused. The focus keeps at the currently focused widget.  This only works for widgets which are not {@link #focusable}.  This is mainly useful for widget authors. Please use with caution!
        /// </summary>
        ...
        /// <summary>
        /// Whether the native context menu should be enabled for this widget. To globally enable the native context menu set the {@link #nativeContextMenu} property of the root widget ({@link qx.ui.root.Abstract}) to true.
        /// </summary>
        ...
        /// <summary>
        /// Mapping to native style property opacity.  The uniform opacity setting to be applied across an entire object. Behaves like the new CSS-3 Property. Any values outside the range 0.0 (fully transparent) to 1.0 (fully opaque) will be clamped to this range.
        /// </summary>
        ...
        /// <summary>
        /// Whether the widget contains content which may be selected by the user.  If the value set to true the native browser selection can be used for text selection. But it is normally useful for forms fields, longer texts/documents, editors, etc.
        /// </summary>
        ...
        /// <summary>
        /// Sets the tooltip instance to use for this widget. If only the tooltip text and icon have to be set its better to use the {@link #toolTipText} and {@link #toolTipIcon} properties since they use a shared tooltip instance.  If this property is set the {@link #toolTipText} and {@link #toolTipIcon} properties are ignored.
        /// </summary>
        ...
        /// <summary>
        /// Controls the visibility. Valid values are:    visible: Render the widget  hidden: Hide the widget but don't relayout the widget's parent.  excluded: Hide the widget and relayout the parent as if the  widget was not a child of its parent. 
        /// </summary>
        ...
        /// <summary>
        /// The event is fired when the widget gets blurred. Only widgets which are {@link #focusable} receive this event.
        /// </summary>
        ...
        /// <summary>
        /// Fired after the creation of a child control. The passed data is the newly created child widget.
        /// </summary>
        ...
        /// <summary>
        /// Fired during the drag. Contains the current mouse coordinates using {@link qx.event.type.Drag#getDocumentLeft} and {@link qx.event.type.Drag#getDocumentTop}  Modeled after the WHATWG specification of Drag&amp;Drop: http://www.whatwg.org/specs/web-apps/current-work/#dnd
        /// </summary>
        ...
        /// <summary>
        /// Fired on a potential drop target when leaving it.  Modeled after the WHATWG specification of Drag&amp;Drop: http://www.whatwg.org/specs/web-apps/current-work/#dnd
        /// </summary>
        ...
        /// <summary>
        /// Fired on a potential drop target when reaching it via the mouse. This event can be canceled if none of the incoming data types are supported.  Modeled after the WHATWG specification of Drag&amp;Drop: http://www.whatwg.org/specs/web-apps/current-work/#dnd
        /// </summary>
        ...
        /// <summary>
        /// Initiate the drag-and-drop operation. This event is cancelable when the drag operation is currently not allowed/possible.  Modeled after the WHATWG specification of Drag&amp;Drop: http://www.whatwg.org/specs/web-apps/current-work/#dnd
        /// </summary>
        ...
        /// <summary>
        /// Fired on the drop target when the drag&amp;drop action is finished successfully. This event is normally used to transfer the data from the drag to the drop target.  Modeled after the WHATWG specification of Drag&amp;Drop: http://www.whatwg.org/specs/web-apps/current-work/#dnd
        /// </summary>
        ...
        /// <summary>
        /// Fired if the widget looses the capturing mode by a call to {@link #releaseCapture} or a mouse click.
        /// </summary>
        ...
        /// <summary>
        /// Fired if the mouse cursor leaves widget.  Note: This event is also dispatched if the widget is disabled!
        /// </summary>
        ...
        /// <summary>
        /// Fired if the mouse cursor enters the widget.  Note: This event is also dispatched if the widget is disabled!
        /// </summary>
        ...
        /// <summary>
        /// Fired after the appearance has been applied. This happens before the widget becomes visible, on state and appearance changes. The data field contains the state map. This can be used to react on state changes or to read properties set by the appearance.
        /// </summary>
