...
{
    /// <summary>
    /// Rich text editor widget which encapsulates the low-level {@link qx.bom.htmlarea.HtmlArea} component to offer editing features.  Optimized for the use in a RIA.
    /// </summary>
    public partial class HtmlArea : qxDotNet.UI.Core.Widget
    {
