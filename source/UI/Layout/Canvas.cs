...
namespace qxDotNet.UI.Layout
{
    ...
    public partial class Canvas : qxDotNet.UI.Layout.Abstract
    {
        ...
        /// <summary>
        /// If desktop mode is active, the children";s minimum sizes are ignored by the layout calculation. This is necessary to prevent the desktop from growing if e.g. a window is moved beyond the edge of the desktop
        /// </summary>
        public bool? Desktop
        {
            get
